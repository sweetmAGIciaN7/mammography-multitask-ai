...
def main():
    ...
    with torch.no_grad():
        ...
        for batch in loader:
            ...
            if isinstance(
                ...
                if len(outputs) != 2:
                    raise RuntimeError(
                        "Expected exactly 2 model outputs."
                    )
    ...
    print(
        "\n=== EXTERNAL CBIS-DDSM HARMONIZED RESULTS ==="
    )
    ...
    plot_confusion_matrix(
        ...
        "External CBIS-DDSM Harmonized: BI-RADS",
        OUTPUT_DIR
    ...
    plot_confusion_matrix(
        ...
        "External CBIS-DDSM Harmonized: Density",
        OUTPUT_DIR
    ...
    metrics = {
        ...
        "evaluation_type":
            "external_no_finetuning_harmonized",

        "preprocessing":
            "label_independent_background_crop_and_percentile_normalization",
