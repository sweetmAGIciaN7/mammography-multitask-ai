...
RESULTS_DIR = ROOT / "results" / "baseline_improved"

CHECKPOINT_PATH = RESULTS_DIR / "best_model.pt"

BIRADS_CM_PATH = (
    RESULTS_DIR / "birads_confusion_matrix.png"
)

DENSITY_CM_PATH = (
    RESULTS_DIR / "density_confusion_matrix.png"
)

BIRADS_REPORT_PATH = (
    RESULTS_DIR / "birads_classification_report.txt"
)

DENSITY_REPORT_PATH = (
    RESULTS_DIR / "density_classification_report.txt"
)
...
ax.set_title(
    "Improved Baseline BI-RADS Confusion Matrix"
)
...
ax.set_title(
    "Improved Baseline ACR Density Confusion Matrix"
)
