# Detailed results, phase by phase

The [README](../README.md) gives the short version. This page has every table, the design choices behind each
experiment, and what each result does and does not show. Numbers come from the committed files in
[`results/`](../results); a one-file index of the headline numbers is
[`results/overview/summary.json`](../results/overview/summary.json).

- [Phase 2: the leakage experiment](#phase-2-the-leakage-experiment-huang--lin--inbreast-masses)
- [Phase 3: a leakage-free multi-task model (CBIS-DDSM)](#phase-3-a-leakage-free-multi-task-model-cbis-ddsm)
- [Phase 4: calibration and external validation](#phase-4-can-the-probabilities-be-trusted-and-does-the-model-travel)
- [Phase 5: do the attention maps point at the lesion?](#phase-5-do-the-attention-maps-point-at-the-lesion)

## Phase 2: the leakage experiment (Huang & Lin / INbreast masses)
