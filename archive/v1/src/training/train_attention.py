"""Two-stage training for attention-guided multi-task model."""
...
def main():
    ...
    checkpoint_path = (
        checkpoint_dir
        / "best_multitask_attention.pt"
    )

    best_val_score = -1.0

    # ----------------------------------------------------------
    # Stage 1: freeze pretrained EfficientNet features.
    # Attention + heads remain trainable.
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # Stage 2: fine-tune full attention-guided network.
    # ----------------------------------------------------------
