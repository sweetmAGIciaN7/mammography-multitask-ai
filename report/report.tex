...
\input{author.tex}   % defines \reportauthor and \reportaffil
...
show what the paper says they show. All code, per-image predictions, figures and an online demo (\url{https://mammography-multitask-ai.streamlit.app}) are public.
